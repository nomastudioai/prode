...
The predictor (Atlas Elo + form) compared against the **57 group-stage matches** already played as of 2026-06-26.

## Overall metrics

| Metric | Value | Reference |
|---|---|---|
| 1X2 accuracy (sign) | **61.4%** (35/57) | random ≈ 33% |
| Exact-score accuracy | 14.0% (8/57) | hard >12% |
| Brier score | 0.561 | 0 perfect, 0.667 random |
| Log-loss | 0.923 | lower is better |
| Mean goal-diff error | 1.47 goals | |
| Baseline "higher-Elo wins" | 61.4% | |
| Real draw rate | 26.3% | |
